...
type Props = {
  phone?: string;          // con indicativo país, p.ej. "57" + número en Colombia
...
export default function WhatsAppFloat({
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[60] flex h-14 w-14 items-center justify-center rounded-full shadow-lg
                 bg-[#25D366] hover:scale-105 transition"
    >
      {/* Ícono WhatsApp en SVG (vector, sin imagen externa) */}
